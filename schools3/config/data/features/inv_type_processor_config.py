...
COL_INV_NAME, COL_INV_DES, COL_INV_LABEL = 'category', 'description', 'Label-ActiveBad'

config.COL_INV_LABEL = ['Label-AcademicExe', 'Label-Vocation', 'Label-Others']
...
def load_mapping_all():
    dict_mapping_all = {}

    for col_label in config.COL_INV_LABEL:
        dict_mapping_all[col_label] = load_mapping(col_label)

    return dict_mapping_all

config.COL_MAPPING = load_mapping_all()
